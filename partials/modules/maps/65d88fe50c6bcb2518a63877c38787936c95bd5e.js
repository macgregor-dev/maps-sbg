...
(function(){
  ...
  .service('mapsService', [
   ...
   function ($q, $firebaseObject, $firebaseArray, $log, authService, $filter) {
     ...
     self.phoneWitnoUrl = "https://congmap-demo.firebaseio.com/bucket/phone";
     self.dncUrl = "https://congmap-demo.firebaseio.com/bucket/dnc";
     self.dropUrl = "https://congmap-demo.firebaseio.com/bucket/drop";
